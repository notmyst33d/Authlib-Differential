...
/* loaded from: authlib-1.5.25.jar:com/mojang/authlib/yggdrasil/YggdrasilGameProfileRepository.class */
    ...
    public void findProfilesByNames(String[] names, Agent agent, ProfileLookupCallback callback) {
        ...
        for (List<String> request : Iterables.partition(criteria, (int) ENTRIES_PER_PAGE)) {
            ...
            do {
                failed = false;
                try {
                    ProfileSearchResultsResponse response = (ProfileSearchResultsResponse) this.authenticationService.makeRequest(HttpAuthenticationService.constantURL(SEARCH_PAGE_URL + agent.getName().toLowerCase()), request, ProfileSearchResultsResponse.class);
                    failCount = 0;
