...
/* loaded from: authlib-3.3.39.jar:com/mojang/authlib/yggdrasil/YggdrasilAuthenticationService.class */
public class YggdrasilAuthenticationService extends HttpAuthenticationService {
    ...
    public <T extends Response> T makeRequest(URL url, Object input, Class<T> classOfT) throws AuthenticationException {
        return (T) makeRequest(url, input, classOfT, null);
    }
    ...
    protected <T extends Response> T makeRequest(URL url, Object input, Class<T> classOfT, @Nullable String authentication) throws AuthenticationException {
        try {
            String jsonResult = input == null ? performGetRequest(url, authentication) : performPostRequest(url, this.gson.toJson(input), "application/json");
    ...
    /* loaded from: authlib-3.3.39.jar:com/mojang/authlib/yggdrasil/YggdrasilAuthenticationService$GameProfileSerializer.class */
    ...
    public UserApiService createUserApiService(String accessToken) throws AuthenticationException {
        return new YggdrasilUserApiService(accessToken, getProxy(), this.environment);
    }
}
