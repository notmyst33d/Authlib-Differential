...
/* loaded from: authlib-1.5.25.jar:com/mojang/authlib/yggdrasil/response/ProfileSearchResultsResponse.class */
public class ProfileSearchResultsResponse extends Response {
    ...
    /* loaded from: authlib-1.5.25.jar:com/mojang/authlib/yggdrasil/response/ProfileSearchResultsResponse$Serializer.class */
