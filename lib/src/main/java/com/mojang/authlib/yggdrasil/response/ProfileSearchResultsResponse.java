...
/* loaded from: authlib-3.3.39.jar:com/mojang/authlib/yggdrasil/response/ProfileSearchResultsResponse.class */
public class ProfileSearchResultsResponse extends Response {
    ...
    /* loaded from: authlib-3.3.39.jar:com/mojang/authlib/yggdrasil/response/ProfileSearchResultsResponse$Serializer.class */
