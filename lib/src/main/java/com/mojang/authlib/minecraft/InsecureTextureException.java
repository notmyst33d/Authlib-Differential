...
/* loaded from: authlib-1.5.25.jar:com/mojang/authlib/minecraft/InsecureTextureException.class */
public class InsecureTextureException extends RuntimeException {
    public InsecureTextureException(String message) {
        super(message);
    }

    /* loaded from: authlib-1.5.25.jar:com/mojang/authlib/minecraft/InsecureTextureException$OutdatedTextureException.class */
    ...
    /* loaded from: authlib-1.5.25.jar:com/mojang/authlib/minecraft/InsecureTextureException$WrongTextureOwnerException.class */
    ...
    /* loaded from: authlib-1.5.25.jar:com/mojang/authlib/minecraft/InsecureTextureException$MissingTextureException.class */
